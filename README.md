...
*Python Script to retrieve AMC problems and solutions provided by the Almighty [Art of Problem Solving](https://artofproblemsolving.com/)*.

## Overview

As a Mathematics olympiad enthusiast and a problem solving addict, in some occasion we will need a collection of problems to be drilled for creating the dopamine i our body. In this repository, I demonstrate how to get high tier mathematics problems from profound website *Art of Problem Solving*. The competition I targeted is contests run by American Mathematics Competitions (AMC) as we know that America is one of high scorer in International Mathematics Olympiad. You can read a history of [American Mathematics Competitions (AMC)](https://artofproblemsolving.com/wiki/index.php?title=American_Mathematics_Competitions) first before choosing which problem set you must download.
