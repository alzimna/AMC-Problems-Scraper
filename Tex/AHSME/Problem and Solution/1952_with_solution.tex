...
A simple method of solving the problem is trying each of the answer choices. One can plug in values of x and y for each, because many x-values and their single corresponding y-values are given.
            ...
            \begin{enumerate}
                \item Choice A works for (1,3) and (2,7) but fails to work on (3,13) because 3*4=12 and 12-1=11, not 13.\item Choice B doesn't work for (2,7) because it would be 8-4+2+2=8, not 7.\item Choice C actually works for all five pairs, being 1+1+1=3, 4+2+1=7, 9+3+1=13, 16+4+1=21, and 25+5+1=31.
            \end{enumerate}
...
Assume that the side length of the square is 4 units. Then the perimeter for both shapes is is 4 * 4 = 16 units. Since the perimeter of a circle is 2πr, then 2πr =16 and r = 8/π, which is about 2.5. The area of a circle is πr\textasciicircum{}2 so (2.5\textasciicircum{}2)*π = 6.25π or about 19.6. This is more than the area of the square, which is 4\textasciicircum{}2 =16, so the answer is $\fbox{B}$.
