...
For a given function $f$, consider the set of elements $Q \in P$ paired with elements $t \in S$ such that $f(Q) \ne t$. Call the set of pairs $(Q,t)$ set $R$.
 ...
 \[\lceil\frac{\lvert R \rvert}{\binom{20}{10}}\rceil = \lceil\frac{10\cdot\binom{20}{9}}{\binom{20}{10}}\rceil = \lceil\frac{100}{11}\rceil = 10\] pairs of a $9$-element subset $Q$ with the tenth element $t$ of that subset such that $f(Q) \ne t$, which satisfies the conditions of the problem.
