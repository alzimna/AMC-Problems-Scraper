...
Adding these, we have
 ...
 \[(x^3+y+1)^2 \equiv -z^9 - 5 .\]By \href{https://artofproblemsolving.com/wiki/index.php?title=Fermat\%27s\_Little\_Theorem}{Fermat's Little Theorem}, the only possible values of $z^9$ are $\pm 1$ and 0, so the only possible values of 
