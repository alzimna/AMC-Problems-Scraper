...
\textbf{Solution 2}
                    ...
                    \begin{figure}[H]
                        \centering
                        \includegraphics[width=0.5\textwidth]{Solution/AIME_1990_I_7_Solution_Figure_2.png}
                    \end{figure}
...
\textbf{Solution 3}
                    ...
                    \begin{figure}[H]
                        \centering
                        \includegraphics[width=0.5\textwidth]{Solution/AIME_1990_I_7_Solution_Figure_3.png}
                    \end{figure}
...
\textbf{Solution 5 (Trigonometry)}
                    ...
                    \begin{figure}[H]
                        \centering
                        \includegraphics[width=0.5\textwidth]{Solution/AIME_1990_I_7_Solution_Figure_4.png}
                    \end{figure}
...
\textbf{Solution 1(Synthetic)}
 ...
 Our triangular pyramid has base $12\sqrt{3} - 13\sqrt{3} - 13\sqrt{3} \triangle$. The area of this isosceles triangle is easy to find by $[ACD] = \frac{1}{2}bh$, where we can find $h_{ACD}$ to be $\sqrt{399}$ by the \href{https://artofproblemsolving.com/wiki/index.php?title=Pythagorean\_Theorem}{Pythagorean Theorem}. Thus $A = \frac 12(12\sqrt{3})\sqrt{399} = 18\sqrt{133}$.
                    ...
                    \begin{figure}[H]
                        \centering
                        \includegraphics[width=0.5\textwidth]{Solution/AIME_1990_I_14_Solution_Figure_2.png}
                    \end{figure}
