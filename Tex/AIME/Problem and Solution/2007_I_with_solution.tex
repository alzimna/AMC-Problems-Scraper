...
\textbf{Solution 1}
                    ...
                    \begin{figure}[H]
                        \centering
                        \includegraphics[width=0.5\textwidth]{Solution/AIME_I_2007_9_Solution_Figure_1.png}
                    \end{figure}
...
\textbf{Solution 4}
                    ...
                    \begin{figure}[H]
                        \centering
                        \includegraphics[width=0.5\textwidth]{Solution/AIME_I_2007_9_Solution_Figure_2.png}
                    \end{figure}
...
\textbf{Solution 5}
                    ...
                    \begin{figure}[H]
                        \centering
                        \includegraphics[width=0.5\textwidth]{Solution/AIME_I_2007_9_Solution_Figure_3.gif}
                    \end{figure}
...
\textbf{Solution 6}
                    ...
                    \begin{figure}[H]
                        \centering
                        \includegraphics[width=0.5\textwidth]{Solution/AIME_I_2007_9_Solution_Figure_4.PNG}
                    \end{figure}
...
Let the radius of the circle be $r$. It can be seen that $\Delta FHO_{1}$ and $\Delta O_{2}GJ$ are similar to $\Delta ACB$, and the length of the hypotenuses are $\frac{17}{8}r$ and $\frac {17}{15}r$, respectively. Then, the entire length of $HJ$ is going to be $(\frac{17}{8}+\frac{17}{15}+2)r = \frac{631}{120}r$. The length of the hypotenuse of $\Delta ACB$ is 34, so the length of the height to $AB$ is $\frac{16*30}{34} = \frac{240}{17}$. Thus, the height to $\Delta HCJ$ is going to be $\frac{240}{17} + r$. $\Delta HCJ$ is similar to $\Delta ACB$ so we have the following: $\frac{\frac{631}{120}r}{34} = \frac{\frac{240}{17} + r}{\frac{240}{17}}$. Cross multiplying and simplifying, we get that $r = \frac{680}{57}$ so the answer is $\boxed{737}$.~Leonard\_my\_dude~
 ...
 \href{https://mathproblemsolvingskills.wordpress.com/}{MathProblemSolvingSkills.com}
	...
	\item (\textit{AIME I 2007}) In a $6 \times 4$ grid ($6$ rows, $4$ columns), $12$ of the $24$ squares are to be shaded so that there are two shaded squares in each row and three shaded squares in each column.  Let $N$ be the number of shadings with this property.  Find the remainder when $N$ is divided by $1000$.
                    ...
                    \begin{figure}[H]
                        \centering
                        \includegraphics[width=0.5\textwidth]{Problem/AIME_I_2007_10_Problem_Figure_1.png}
                    \end{figure}
...
There are ${6\choose3}$ to choose the arrangement of the shaded squares in each column. Examine the positioning of the shaded squares in the first two columns:
                    ...
                    \begin{figure}[H]
                        \centering
                        \includegraphics[width=0.5\textwidth]{Solution/AIME_I_2007_10_Solution_Figure_1.PNG}
                    \end{figure}
...
\textbf{Solution}
                    ...
                    \begin{figure}[H]
                        \centering
                        \includegraphics[width=0.5\textwidth]{Solution/AIME_I_2007_12_Solution_Figure_1.png}
                    \end{figure}
...
\textbf{Solution 3}
                    ...
                    \begin{figure}[H]
                        \centering
                        \includegraphics[width=0.5\textwidth]{Solution/AIME_I_2007_12_Solution_Figure_2.png}
                    \end{figure}
...
Note first that the intersection is a \href{https://artofproblemsolving.com/wiki/index.php?title=Pentagon}{pentagon}.
 ...
 <center> 
                    \begin{figure}[H]
                        \centering
                        \includegraphics[width=0.5\textwidth]{Solution/AIME_I_2007_13_Solution_Figure_1.png}
                    \end{figure}
                    
                    \begin{figure}[H]
                        \centering
                        \includegraphics[width=0.5\textwidth]{Solution/AIME_I_2007_13_Solution_Figure_2.png}
                    \end{figure}
...
<center> 
                    \begin{figure}[H]
                        \centering
                        \includegraphics[width=0.5\textwidth]{Solution/AIME_I_2007_13_Solution_Figure_3.png}
                    \end{figure}
...
\textbf{Solution}
                    ...
                    \begin{figure}[H]
                        \centering
                        \includegraphics[width=0.5\textwidth]{Solution/AIME_I_2007_15_Solution_Figure_1.png}
                    \end{figure}
