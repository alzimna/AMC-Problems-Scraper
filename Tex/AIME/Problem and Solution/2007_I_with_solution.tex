...
\textbf{Solution 4}
                    ...
                    \begin{figure}[H]
                        \centering
                        \includegraphics[width=0.5\textwidth]{Solution/AIME_2007_I_9_Solution_Figure_2.png}
                    \end{figure}
...
\textbf{Solution 5}
                    ...
                    \begin{figure}[H]
                        \centering
                        \includegraphics[width=0.5\textwidth]{Solution/AIME_2007_I_9_Solution_Figure_3.gif}
                    \end{figure}
...
\textbf{Solution 6}
                    ...
                    \begin{figure}[H]
                        \centering
                        \includegraphics[width=0.5\textwidth]{Solution/AIME_2007_I_9_Solution_Figure_4.PNG}
                    \end{figure}
...
\textbf{Solution 3}
                    ...
                    \begin{figure}[H]
                        \centering
                        \includegraphics[width=0.5\textwidth]{Solution/AIME_2007_I_12_Solution_Figure_2.png}
                    \end{figure}
...
Note first that the intersection is a \href{https://artofproblemsolving.com/wiki/index.php?title=Pentagon}{pentagon}.
 ...
 <center> 
                    ...
                    \begin{figure}[H]
                        \centering
                        \includegraphics[width=0.5\textwidth]{Solution/AIME_2007_I_13_Solution_Figure_2.png}
                    \end{figure}
...
<center> 
                    \begin{figure}[H]
                        \centering
                        \includegraphics[width=0.5\textwidth]{Solution/AIME_2007_I_13_Solution_Figure_3.png}
                    \end{figure}
