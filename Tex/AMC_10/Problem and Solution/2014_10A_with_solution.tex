...
There are $3$ ways to pick the dice which is the sum. From here proceed with "casework":
            ...
            \begin{itemize}
        \item If the sum is 1, there are $0$ ways because the minimum sum is $2$.
        \item If the sum is 2, there is $1$ way (namely $(1, 1)$).
        \item If the sum is 3, there are $2$ ways (namely $(1, 2)$ and $(2, 1)$).
        \item If the sum is 4, there are $3$ ways (namely $(1, 3)$, $(3, 1)$, and $(2, 2)$).
            \end{itemize}
            We start noticing that for a sum of $n$ there are $n-1$ cases, but let's keep going to verify.

 
            \begin{itemize}
        \item If the sum is 5, there are $4$ ways (namely $(1, 4)$, $(4, 1)$, $(2, 3)$, and $(3, 2)$).
        \item If the sum is 6, there are $5$ ways (namely $(1, 5)$, $(5, 1)$, $(2, 4)$, $(4, 2)$, and $(3, 3)$).
            \end{itemize}
