...
Let the brackets denote areas. We are given that 
 ...
 We apply casework to the right angle of $\triangle PQR:$
            ...
            \begin{enumerate} 
        \item If $\angle P=90^\circ,$ then $R\in\{R_1,R_5\}$ by the tangent.
...
<u>\textbf{Remarks}</u>
            ...
            \begin{enumerate} 
        \item The reflections of $R_1,R_2,R_3,R_4$ about $\overleftrightarrow{PQ}$ are $R_5,R_6,R_7,R_8,$ respectively.
...
Note that cycles exist initially and after each round of erasing.
 ...
 Let the parentheses denote cycles. It follows that:
            ...
            \begin{enumerate} 
        \item Initially, the list has cycles of length $5:$ 
...
Note that cycles exist initially and after each round of erasing.
 ...
 We will consider one cycle after all three rounds of erasing. Suppose this cycle has length $L$ before any round of erasing. It follows that:
            ...
            \begin{enumerate} 
        \item Initially, one cycle has length $5,$ from which $L$ must be divisible by $5.$
        ...
        \item After the third round of erasing, one cycle has length $L\left(1-\frac13\right)\left(1-\frac14\right)\left(1-\frac15\right)=\frac25L,$ from which $L$ must be divisible by $5.$
            ...
            \end{enumerate}
            The least such positive integer $L$ is $\operatorname{lcm}(5,3,2)=30.$ So, there is a repeating pattern for every $30$ digits on the original list. As shown below, the digits erased in the first, second, and third rounds are colored in red, yellow, and green, respectively:
                    \begin{figure}[H]
                        \centering
