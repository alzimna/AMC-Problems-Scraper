...
We can solve this problem with a brute force approach.
            ...
            \begin{itemize}
        \item If Cal's number is $1$:<ul><li>If Bill's number is $2$, Al's can be any of $4, 6, 8, 10$.</li><li>If Bill's number is $3$, Al's can be any of $6, 9$.</li><li>If Bill's number is $4$, Al's can be $8$.</li><li>If Bill's number is $5$, Al's can be $10$.</li><li>Otherwise, Al's number could not be a whole number multiple of Bill's.</li></ul>
        \item If Cal's number is $2$:<ul><li>If Bill's number is $4$, Al's can be $8$.</li><li>Otherwise, Al's number could not be a whole number multiple of Bill's while Bill's number is still a whole number multiple of Cal's.</li></ul>
        \item Otherwise, Bill's number must be greater than $5$, i.e. Al's number could not be a whole number multiple of Bill's.
            \end{itemize}
