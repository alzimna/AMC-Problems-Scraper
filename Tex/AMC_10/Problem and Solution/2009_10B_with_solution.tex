...
Extend line segment $QM$ past $M$ until it intersects the line containing side $RS$ at point $T$:
 ...
 Consider $\triangle PMQ$ and $\triangle SMT$:
            ...
            \begin{itemize}
        \item $\angle MPQ = \angle MST = 90^\circ$ (interior angles of a square and its linear extension).
        \item $PM = MS = 1$ (since $M$ is the midpoint of $PS$).
        \item $\angle PMQ = \angle SMT$ (vertical angles).
            \end{itemize}
 ...
 Now examine the large right triangle $\triangle RTQ$, tracking angles from the right angle ($R$), to the shallow angle ($T$), to the sharp angle ($Q$):
            ...
            \begin{itemize}
        \item $\angle QRT = 90^\circ$ because the horizontal base extension line $RT$ meets the vertical square side $QR$ at a right angle.
        \item $RN$ is an altitude drawn from the right angle $R$ to the hypotenuse $QT$, since $RN \perp MQ$ and points $Q, N, M, T$ are collinear.
            \end{itemize}
            ...
            \begin{enumerate}
        \item $\triangle NTR \sim \triangle RTQ$ (sharing acute angle $\angle NTR$ and a right angle).
        \item $\triangle NRQ \sim \triangle RTQ$ (sharing acute angle $\angle RQT$ and a right angle).
        \item By the Law of Syllogism (Transitivity of Similarity), $\triangle NTR \sim \triangle NRQ$.
            \end{enumerate}
