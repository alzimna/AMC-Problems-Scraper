...
Since there are $3$ equal spaces between $AB$ and $ED$, the total height, $AE$ of the hexagon is:
 ...
 For the trapezoid $ABWZ$:
            ...
            \begin{itemize}
        \item The shorter base is $AB = q = 3p$.
        \item The legs have length $3p - p = 2p$
        \item The height is the spacing between the parallel lines, which is $p\sqrt{3}$.
        \item The longer base $ZW$ extends past $AB$ by a distance of $p$ on each side due to the $30^\circ-60^\circ-90^\circ$ geometry in $\triangle AJY$ and $\triangle BKX$, so $WZ = q + 2p = 3p + 2p = 5p$.
            \end{itemize}
