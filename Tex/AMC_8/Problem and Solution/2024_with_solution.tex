...
Let $x$ denote the number of guppies in the first tank.
 ...
 Then, we have the following for the number of guppies in the rest of the tanks:
                ...
                \begin{itemize}
                    \item The number of guppies in the second tank is $x+1$\item The number of guppies in the third tank is $x+1+2$\item The number of guppies in the fourth tank is $x+1+2+3$
                \end{itemize}
...
We can cross off a few routes:
                ...
                \begin{itemize}
                    \item AM can be crossed off because AXM is shorter\item XY can be crossed off because XMY is shorter\item YZ can be crossed off because YCZ is shorter\item MC can be crossed off because MYC is shorter\item MZ can be crossed off because MCZ is shorter
                \end{itemize}
